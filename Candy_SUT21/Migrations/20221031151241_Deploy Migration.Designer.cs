...
namespace Candy_SUT21.Migrations
{
    ...
    [Migration("20221031151241_Deploy Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Candy_SUT21.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "98de4337-461b-48b6-a5b2-4952f2f95df1",
                            Email = "admin@djinn.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@DJINN.COM",
                            NormalizedUserName = "ADMIN@DJINN.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEKx7DxeWq4Qzp2eNcKYWo88Si2BkuuoaLLdOy6GJ26NnwqZK/tiqJmSR+BuMmPNMmQ==",
                            PhoneNumber = "123456789",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "f31b9c83-7dcf-4d4a-8dd3-6b9265db4b00",
            ...
            modelBuilder.Entity("Candy_SUT21.Models.Order", b =>
                {
                    b.HasOne("Candy_SUT21.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
